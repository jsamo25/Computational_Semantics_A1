...
# 13.Using LogisticRegressionCV
print("\nChanging model to use CrossValidation...")
...
print("\n Initial model score, using a weak regularization, C=50")
print("training set score: ", model.score(x_train, y_train))
print("testing set score:  ", model.score(x_test, y_test))
...
plt.figure()
plot_confusion_matrix(
    cnf_matrix, classes=["True", "False"], title="Confusion matrix"
)
plt.show()
